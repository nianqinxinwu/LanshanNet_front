			...
			return {
				tabList: [
					...
					},
					{
						...
						url: '/pages/fc/fc_products/fc_products'
					},
					{
						key: 'orders',
						label: '订单',
						...
						url: '/pages/fc/fc_orders/fc_orders'
					},
					{
						key: 'profile',
						label: '我的',
						...
						url: '/pages/fc/fc_profile/fc_profile'
					}
				]
			}
		},
